{
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/KhansaKhanam/PhysiologicalAgeAnalysis/blob/main/PA_part1.R\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        "system('git config --global user.email \"khanamkhansaprof@protonmail.com\"')\n",
        "system('git config --global user.name \"KhansaKhanam\"')"
      ],
      "execution_count": 45,
      "outputs": []
    },
    {
      "cell_type": "code",
      "source": [
        "system('git clone https://github.com/KhansaKhanam/PhysiologicalAgeAnalysis.git')"
      ],
      "metadata": {
        "id": "KkSRqNTHh2t5"
      },
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "system('git commit -m \"Data Wrangling - NHANES Dataset\"')\n"
      ],
      "metadata": {
        "id": "Ve7KkEppiXfD"
      },
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMZjvl9YLNb6EZiOazRe6Hm",
